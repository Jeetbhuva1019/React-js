...
export default function Create() {
    ...
    return (
        <div className="signIn-container">
            ...
            <input type="text" placeholder='Hobby' className="input" onChange={(e) => setHobby(e.target.value)} />
            <input type="text" placeholder='City' className="input" onChange={(e) => setAge(e.target.value)} />
